...
export const Button = ({
  ...
  const variants = {
    primary: "bg-gradient-to-r from-luxury-gold to-luxury-darkgold text-black shadow-gold-glow hover:shadow-gold-glow-lg border border-luxury-gold/20",
    secondary: "bg-white/5 border border-white/10 text-white hover:bg-white/10 hover:border-luxury-gold/30 backdrop-blur-md",
    danger: "bg-rose-950/40 border border-rose-500/30 text-rose-200 hover:bg-rose-950/60 hover:border-rose-500/60",
